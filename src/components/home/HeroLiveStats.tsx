      ...
      <div className="inline-flex items-center gap-4 rounded-full border border-gray-200 bg-white/80 backdrop-blur px-4 py-2 shadow-sm animate-[fadein_0.6s_ease_0.1s_forwards] opacity-0">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm text-gray-700">
            <strong className="text-gray-900 font-semibold">{totalUsers.toLocaleString()}</strong> istifadəçi
          </span>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm text-gray-700">
            <strong className="text-gray-900 font-semibold">{onlineUsers.toLocaleString()}</strong> online
          </span>
        </div>
      </div>
    </div>
