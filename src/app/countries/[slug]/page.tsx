...
export default async function CountryDetailPage(context: CountryPageProps) {
  ...
  const getLocalizedContent = (i18nField: any, fallbackField: string | null) => {
    if (!i18nField || typeof i18nField !== 'object') return fallbackField || ''
    // Try locale, then 'en', then any available language, then fallback
    return i18nField[locale] || i18nField['en'] || Object.values(i18nField).find((v: any) => v) || fallbackField || ''
  }
      ...
      <CountryTabs
        ...
        overview={
          <div className="space-y-6">
            {/* Mobile Widgets - Show on mobile, hide on desktop */}
            ...
            <div className="lg:col-span-2 space-y-6">
              {/* Description */}
              {(country.culture_description || country.culture_description_i18n) && (
              ...
              <Card className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  {(country.best_time_to_visit || country.best_time_to_visit_i18n) && (
                    <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                  ...
                  {(country.climate_info || country.climate_info_i18n) && (
                    <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
              ...
              {(country.visa_info || country.visa_info_i18n || country.entry_requirements || country.entry_requirements_i18n) && (
            ...
            <div className="space-y-6">
              ...
              {/* Currency Exchange - Desktop Only */}
              {country.currency && (
                <div className="hidden lg:block">
                  <Card className="bg-white border border-gray-200 rounded-xl p-4 shadow-sm">
                    <CurrencyExchange 
              ...
              {/* AI Advice */}
              {(country.airen_advice || country.airen_advice_i18n) && (
